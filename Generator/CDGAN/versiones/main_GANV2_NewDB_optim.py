...
def arguments():
    ...
    parser.epochs = 300 #Anterior 500
    ...
    parser.device = "cpu"
    parser.learning_rate =9e-5 #Anterior: 2e-4
    ...
    parser.output_folder="output_30Oct_ganV2_128_optim_9e5/"
...
def main():
    ...
    date="_GANV2_128_FWHM_ADAM_30Oct_optim_9e5"
