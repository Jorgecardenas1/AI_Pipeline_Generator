...
def arguments():
    ...
    parser.epochs = 600 #Anterior 500
    ...
    parser.output_folder="output_6Ene_ganV2_HighAbs_512depth_batch32_512_z400_NoWCond_1pxFringe/"
...
def main():
    ...
    date="_GANV2_6Ene_HighAbs_512Depth_batch32_512_z400_NoWCond_1pxFringe"
