...
def arguments():
    ...
    parser.epochs = 400 #Anterior 500
    ...
    parser.condition_len = 13 #without shape conditioning
    ...
    parser.output_folder="output_25DIC_ganV2_HighAbs_128_NoWidthCond/"
...
def set_conditioning(df,name,target,categories,band_name,top_freqs):
    ...
    #"circ":[1,0,0],"box":[0,1,0], "cross":[0,0,1]
...
def main():
    ...
    date="_GANV2_HighAbs_128_FWHM_ADAM_25DIC_ganV2_128_optim_2e4_batch64_z400_e800_gamma0.99_0.15_noise_0.2low"
